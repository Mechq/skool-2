...
export default function DeleteConfirmationModalScreen({ onClose, onSave, commissionId, commissionName }) {
    const handleDelete = () => {
        fetch(`/api/workshop/${commissionId}`, {
            method: 'DELETE',
        })
            .then(() => {
    ...
    console.log("workshopId", commissionId);
    return (
        <>
                    ...
                    <div className="w-full bg-white rounded-lg shadow light:border light:bg-gray-800 light:border-gray-700">
                        <div className="p-6 space-y-4 sm:space-y-6">
                            ...
                            <h2 className="">Weet u zeker dat u de workshop <br />
                                '<strong>{commissionName}</strong>' wilt verwijderen?</h2>
