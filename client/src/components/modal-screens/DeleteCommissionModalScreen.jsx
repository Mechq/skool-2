...
export default function DeleteConfirmationModalScreen({ onClose, onSave, commissionId, commissionName, commissionDate }) {
    const handleDelete = () => {
        onSave()
    };
                ...
                <div className="flex flex-col items-center justify-center w-80">
                    <div className="w-full bg-white rounded-lg shadow light:border light:bg-gray-800 light:border-gray-700">
                        <div className="p-6 space-y-4 sm:space-y-6">
                            ...
                            <h1 className="text-xl font-medium m-0 p-0" style={{ marginTop: 0 }}>Opdracht verwijderen</h1>
                            <h2 className="">Weet u zeker dat u de opdracht van <br />
                                '<strong>{commissionName}</strong>' op <strong>{formatDate(commissionDate)}</strong> wilt verwijderen?</h2>
