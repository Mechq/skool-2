    ...
    return (
        <section className='px-6 py-8 mx-6'>
            <form onSubmit={handleRegister} className="relative">
                ...
                <button type="submit"
                        className="mb-2 text-white bg-brand-orange hover:bg-brand-orange-hover focus:ring-4 focus:outline-none focus:ring-brand-orange-light font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                    Registreer
                </button>
            </form>
        </section>
