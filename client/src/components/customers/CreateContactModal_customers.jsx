...
export default function DeleteConfirmationModalScreen({onClose, onSave, commissionName, commissionDate}) {
    const handleDelete = () => {
        onSave()
    };
                    ...
                    <div
                        ...
                        <div className="p-6 space-y-4 sm:space-y-6">
                            ...
                            <h2 className="">Weet u zeker dat u de opdracht van <br/>
                                '<strong>{commissionName}</strong>'
                                op <strong>{formatDate(commissionDate)}</strong> wilt verwijderen?</h2>
