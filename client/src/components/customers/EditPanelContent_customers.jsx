...
function EditPanelContent_customers({customerId, setShowSidePanel}) {
    ...
    return (
        <div>
            <header className='side-panel-title pt-4 pb-4 font-bold text-lg'>Bewerk klant</header>
            <div className='side-panel-content p-4'>
                ...
                <p className="mb-4 mt-8 text-lg font-medium text-gray-900">Contactpersonen</p>
                <div className="overflow-x-auto relative shadow-md sm:rounded-lg mb-6">
                    <table className="w-full text-sm text-left text-gray-500 light:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" className="py-2 px-2">Verwijder</th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <button
                    ...
                    className="mb-4 text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-blue-500 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                >
