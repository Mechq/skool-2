...
export default function Warning_toasts({ message, onClose }) {
    useEffect(() => {
    ...
    return (
        <div id="toast-warning"
             ...
             role="alert">
            <div
                className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-orange-500 bg-orange-100 rounded-lg light:bg-orange-700 light:text-orange-200">
