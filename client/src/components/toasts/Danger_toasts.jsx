...
export default function Danger_toasts({message, onClose}) {
    ...
    return (
        <div id="toast-danger"
             ...
             role="alert">
            <div
                className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg light:bg-red-800 light:text-red-200">
