...
export default function Success_toasts({ message, onClose }) {
    useEffect(() => {
        const timer = setTimeout(() => {
            onClose(); // Call onClose after 3000 milliseconds (3 seconds)
        }, 3000);
    ...
    return (
        <div id="toast-bottom-right" className="flex items-center max-w-xs p-4 space-x-4 text-gray-500 bg-white rounded-lg shadow light:text-gray-400 light:divide-gray-700 space-x light:bg-gray-800" role="alert">
