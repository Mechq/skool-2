...
export default function ConfirmRejectModal_teacherEnrollments({onClose, onConfirm, enrollment, setEnrollments, reason}) {
    const handleReject = () => {
                ...
                <div
                        ...
                        <div className="p-6 space-y-4 sm:space-y-6">
                            ...
                            <textarea id="reason" rows="4"
                                      ...
                                      placeholder="Voer hier een reden in..."></textarea>
